...
def get_layout(
    ...
    transformed_y: Optional[Dict[str, Callable]] = None,
    **kwargs,
) -> html.Div:
    ...
    content = get_content(fit, name=name, plot_fcns=plot_fcns, transformed_y=transformed_y) if use_default_content else None
